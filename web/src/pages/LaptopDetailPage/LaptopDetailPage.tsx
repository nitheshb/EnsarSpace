                ...
                {filterData.map((asset) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-sm text-gray-500">{asset.Email}</div>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800 ${asset.WorkingStatus === 'Active' ? 'bg-green-100' : 'bg-red-100'}`}>
                      {asset.WorkingStatus}
                      </span>
                      </td>
