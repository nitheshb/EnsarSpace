...
import HeaderComponent from 'src/pages/Profile/HeaderComponent'
          ...
          <div className="flex flex-col text-gray-700 bg-white">
            ...
            <div className="flex flex-row relative ml-[22vw] w-full">
                ...
                >
                  ...
                  <div className="flex flex-col">
                    ...
                    <div
                      ...
                      className="border border-black hover:text-grey-800 p-8 mx-auto max-w-full font-sans flex shadow-lg rounded-lg"
                    ...
                    <button
                      ...
                      className="flex-grow mt-[20%] mb-6 flex flex-col items-center justify-center bg-gray-300 rounded-md border border-black w-full p-2 rounded-lg"
              ...
              <div
                ...
                style={{ right: '15rem', top: '100%', left: '0rem' }}
