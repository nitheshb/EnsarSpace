...
//   return (
//     <>
//       <MetaTags title="LeaveManagement" description="LeaveManagement page" />

//       <h1>LeaveManagementPage</h1>
//       <p>
//         Find me in <code>./web/src/pages/LeaveManagementPage/LeaveManagementPage.tsx</code>
//       </p>
//       <p>
//         My default route is named <code>leaveManagement</code>, link to me with `
//         <Link to={routes.leaveManagement()}>LeaveManagement</Link>`
//       </p>
//     </>
//   )
// }
...
const LeaveManagementPage = () => {
  ...
  const [selModule, setSelModule] = useState('Leave')
      ...
      <div className="flex w-screen h-screen text-gray-700">
        <div className="flex flex-col flex-grow">
          ...
          <div className="flex flex-row overflow-auto  text-gray-700 bg-gradient-to-tr from-blue-200 via-indigo-200 to-pink-200">
            <SlimSideMenuBar
              pgName={'leaveManagModule'}
              sourceLink={'leaveManagModule'}
