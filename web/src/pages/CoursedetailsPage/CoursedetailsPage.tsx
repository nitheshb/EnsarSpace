    ...
    <nav className="navbar">
      ...
      <div style={{ backgroundColor: 'black', color: 'white' }}>
        <div className="course-intro mx-auto grid bg-dark">
           ...
           {course.category}
            ...
            <div className="course-body">
              ...
              <div className="course-rating flex">
                ...
                <span className="students-count fs-14">{course.students}</span>
              </div>
              ...
              <ul className="course-info">
                <li>
                  <span className="fs-14">
                    Created by{' '}
                    <span className="fw-6 opacity-08">{course.creator}</span>
                  </span>
                </li>
                <li className="flex">
                  <span>
                ...
                <li className="flex">
                  ...
                  <span className="fs-14 course-info-txt fw-5">{course.lang}</span>
                </li>
                <li className="flex">
                  <span>
            ...
            <div className="course-foot">
              <div className="course-price">
                ...
                <span className="old-price fs-26 fw-6">${course.actual_price}</span>
              </div>
            </div>
          ...
          <img
              src={course.image}
              alt={course.category}  className="responsive-image"
              style={{
                width: '100%',
                height: 'auto',
                objectFit: 'cover',
    ...
    course.what_you_will_learn.map((what_you_will_learn, idx) => {
      return (
        <li key={idx}>
          ...
          <span className="fs-14 fw-5 opacity-09">{what_you_will_learn}</span>
        </li>
      );
    })}
</ul>
