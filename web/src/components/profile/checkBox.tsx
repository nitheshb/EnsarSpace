  ...
  return (
    ...
    >
      <div className="w-full   flex flex-row py-4 items-center">
        <p className="text-2xl">Contributing to</p>{' '}
      </div>

      <div>
        <div className="border-[#2499EF] rounded-xl border w-full">
          <span className="flex">
            <img src="https://jira-frontend-static.prod.public.atl-paas.net/assets/ProjectsAndGoalsEmptyStateImage.5dbf0ebae4e56f0430a948fbadc6ee9a.8.svg"></img>

            <div>
              <h3 className="px-4 py-2 text-2xl">
              ...
              <span className="flex p-2">
                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      <stop offset="0.5" stop-color="#2684FF"></stop>
                    ...
                    <linearGradient
                      ...
                      gradientUnits="userSpaceOnUse"
                    >
                      <stop stop-color="#0E65DF"></stop>
                      <stop offset="1" stop-color="#0255CF"></stop>
                    </linearGradient>
                    <linearGradient
                    ...
                    >
                      ...
                      <stop offset="0.59" stop-color="#156EE8"></stop>
                      <stop offset="1" stop-color="#0E65DF"></stop>
                    </linearGradient>
                    <linearGradient
                      ...
                      gradientUnits="userSpaceOnUse"
                    >
                      <stop offset="0.26" stop-color="#2684FF"></stop>
                      <stop offset="1" stop-color="#0E65DF"></stop>
                    </linearGradient>
                    <linearGradient
                    ...
                    <linearGradient
                      ...
                      gradientUnits="userSpaceOnUse"
                    >
                      <stop offset="0.36" stop-color="#2684FF"></stop>
                      <stop offset="1" stop-color="#0052CC"></stop>
                    </linearGradient>
                    <linearGradient
                      ...
                      gradientUnits="userSpaceOnUse"
                    >
                      <stop offset="0.06" stop-color="#2684FF"></stop>
                      <stop offset="0.58" stop-color="#0052CC"></stop>
                      <stop offset="1" stop-color="#2684FF"></stop>
                    </linearGradient>
                  </defs>
                </svg>

                <span className="pl-2">Powdered by Ensar</span>
              </span>
              <p className="px-2 text-sm">
                Help teammates see a summary of what you work on, its current
                status and the goals it contributes to.
              </p>
            </div>
          </span>
