  ...
  return (
    ...
    >
      <div className="w-full   flex flex-row py-4 items-center">
        <p className="text-[20px]">Places you worked in </p>{' '}
      </div>
      ...
      <div>
        <div className="border-black rounded-xl border w-full drop-shadow">
          <div className="flex p-2">
            ...
            <p className="text-[15px] p-2 font-bold ">ENSAR </p>
          </div>
          <div className="flex p-2">
            <img
              className="w-8 h-8"
              ...
              alt="python"
            ></img>
            <p className="p-2 font-bold text-[15px]">PYTHON </p>
          </div>
          <div className="flex p-2">
            <img
              className="w-8 h-8"
              ...
              alt="web development"
            ></img>
            <p className="p-2 font-bold text-[15px]">WEB DEVELOPMENT </p>
          </div>
          <div className="flex p-2">
            <img
              className="w-8 h-8"
            ...
            <p className="p-2 font-bold text-[15px]">AWS </p>
          </div>
        </div>
      </div>
    </section>
