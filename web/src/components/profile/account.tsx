...
const Account = () => {
  return (
    ...
    >
      ...
      <div>
        <div className="border-[#2499EF] rounded-xl border w-full drop-shadow">
          <div className="flex p-2">
            ...
            <p className="text-[violet] p-2 font-bold ">Ensar </p>
          </div>
          <div className="flex p-2">
            <img
              className="w-10 h-10"
              ...
              alt="python"
            ></img>
            <p className="p-2 font-bold text-2xl">PYTHON </p>
          </div>
          <div className="flex p-2">
            <img
              className="w-10 h-10"
              ...
              alt="web development"
            ></img>
            <p className="p-2 font-bold text-2xl">WEB DEVELOPMENT </p>
          </div>
          <div className="flex p-2">
            <img
              className="w-10 h-10"
            ...
            <p className="p-2 font-bold text-2xl">AWS </p>
          </div>
        </div>
      </div>
    </section>
