...
//       // await updateAssetDetails(user.orgId, values, SerialNumber)
...
//   // const handleUpdate = async (assetPayload) => {

//   //   console.log('Submitted', assetPayload)
...
//   //     // await updateAssetDetails(user.orgId, assetPayload)
