...
const SlimSideMenuBar = (props) => {
  ...
  return (
    <div className="flex flex-col items-center w-20 min-w-[83px] pb-4   bg-white bg-opacity-75  bg-[#f0f3ff] h-screen w-[83px] max-w-[83px]">
      ...
      {['leaveManagModule'].includes(sourceLink) && (
        <>
          <ul className="w-full">
            <li className="relative mt-1 ">
              ...
              >
                <span className="flex items-center flex-col pt-[8px]">
                  ...
                  <span className="text-[9px] font-bold  pl-1">My Leaves</span>
                </span>
              </span>
            </li>
            <li className="relative mt-1">
              ...
              >
                <span className="flex items-center flex-col pt-[8px]">
                  ...
                  <span className="text-[9px] font-bold  pl-1">Leave Approval</span>
                </span>
            ...
            <li className="relative mt-1">
              ...
              >
                <span className="flex items-center flex-col pt-[8px]">
                  ...
                  <span className="text-[9px] font-bold  pl-1">Holiday's</span>
                </span>
                <span className="flex ml-auto items-bottom">
                  <span className="flex ml-auto items-bottom text-xs mt-2"></span>
                </span>
            ...
            <li className="relative mt-1">
              ...
              >
                <span className="flex items-center flex-col pt-[8px]">
                  ...
                  <span className="text-[9px] font-bold  pl-1">PaySlips</span>
                </span>
                <span className="flex ml-auto items-bottom">
                  <span className="flex ml-auto items-bottom text-xs mt-2"></span>
                </span>
...
<li className="relative mt-1">
            ...
            {/* <li className="relative mt-1">
              <span
                ...
                onClick={() => setViewable('AttendancePage')}
                style={{
                  display: 'block',
                  marginLeft: 'auto',
                  marginRight: 'auto',
