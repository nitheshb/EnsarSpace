...
import { ROLES_LIST,COURSE_LIST,GENDER_LIST } from 'src/constants/userRoles'
    ...
    <div className="h-full flex flex-col py-6 bg-white shadow-xl overflow-y-scroll">
      <div className="px-4 sm:px-6">
        <Dialog.Title className=" font-semibold text-lg mr-auto ml-3">
          {editMode ? 'Edit Employee Details' : 'Course Form'}
        </Dialog.Title>
      </div>
      {formMessage.message && (
              ...
              <Form>
                ...
                /> */}
                 ...
                 <CustomSelect
                  ...
                  onChange={(value) => {
                    changed(value)
                    formik.setFieldValue('gendVal', value.value)
                    formik.setFieldValue('myRole', '')
                  }}
                  value={formik.values.gendVal}
                  options={GENDER_LIST}
                />
                {formik.errors.gendVal ? (
                ...
                <CustomSelect
                  ...
                  onChange={(value) => {
                    changed(value)
                    formik.setFieldValue('courVal', value.value)
                    formik.setFieldValue('myRole', '')
                  }}
                  value={formik.values.courVal}
                  options={COURSE_LIST}
                />
                {formik.errors.courVal ? (
                  <div className="error-message text-red-700 text-xs p-2">
                    {formik.errors.courVal}
                  </div>
                ) : null}
