...
//   // Function to handle changes in the End Date field
...
//     <Card>
//       <Card sx={{ mt: 2 }}>
//       <CardContent sx={{ display: 'flex', justifyContent: 'space-between', border: 'none' }}>
...
//           sx={{ width: '150px', marginRight: '5px' }}
//         />
//         <Button variant="contained" onClick={handleSearch} disabled={!startMonth || !endMonth}>
//           <SearchIcon />
//         </Button>
//       </CardContent>
//     </Card>
