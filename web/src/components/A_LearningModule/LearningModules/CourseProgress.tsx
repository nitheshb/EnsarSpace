...
import MyJourneyNavBar from 'src/pages/MyJourneyPage/MyJourneyNavBar'
import CardLayout from './CourseLayout'
...
const CourseProgress = () => {
  ...
  return (
    <>
      <MyJourneyNavBar selModule={'Learning'} setSelModule={'Module'} />
      <div>
