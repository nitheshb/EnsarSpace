...
//   const [ratingMessage, setRatingMessage] = useState(''); // Star Rating Messages
//   const { user } = useAuth();
...
const AddCourseDialog = ({ isOpen, onClose }) => {
  ...
  const validate = Yup.object({
    ...
    creator: Yup.string().required('Author is required'),
              ...
              <Form>
                ...
                <CustomSelect
                  ...
                  onChange={(selectedOption) =>
                    ...
                    formik.setFieldValue('creator', selectedOption.value)
                ...
                {ratingMessage && (
                  ...
                  <p className="text-sm text-gray-500 mt-1">{ratingMessage}</p>
