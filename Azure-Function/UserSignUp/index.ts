...
const { getFirestore, initializeFirestore,doc, setDoc, updateDoc, getDoc, addDoc, collection, arrayUnion } = require("firebase/firestore");
...
module.exports = async function (context, req) {
   ...
   try {
    ...
    responseMessage =   {success: false, msg: `Error at User Creation ${email} ${password}  ${req.body}`, payload: JSON.stringify(e)}
    context.res = {
        // status: 200, /* Defaults to 200 */
        body: responseMessage
    };
